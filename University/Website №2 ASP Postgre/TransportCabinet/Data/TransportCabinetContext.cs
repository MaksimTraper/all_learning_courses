...
namespace TransportCabinet.Data;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Transport>(entity =>
        {
            ...
            entity.HasOne(d => d.fk_id_vehicle_navigation).WithMany(p => p.transports)
                .HasForeignKey(d => d.fk_id_vehicle)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("transport_fk_id_vehicle_fkey");
        });
        ...
        modelBuilder.Entity<TransportCard>(entity =>
        {
            ...
            entity.HasOne(d => d.fk_id_owner_navigation).WithMany(p => p.transport_cards)
                .HasForeignKey(d => d.fk_id_owner)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("transport_card_fk_id_owner_fkey");
        });
        ...
        modelBuilder.Entity<Trip>(entity =>
        {
            ...
            entity.Property(e => e.pk_num_trip)
                .ValueGeneratedOnAdd()
                .HasColumnName("pk_num_trip");
            entity.Property(e => e.fk_id_card).HasColumnName("fk_id_card");
        ...
        {
            entity.HasKey(e => e.passport_num).HasName("user_account_pkey");
